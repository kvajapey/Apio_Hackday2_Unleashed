    ...
    public static void CalculateFeatures(String fileName) throws IOException{
        ...
        for(i = 0; i < (timeLength); i++){
            ...
            classifications.add(i, EventClassifier.Classify(meanAccelList[0].get(i), meanAccelList[1].get(i), meanAccelList[2].get(i), 
                    ...
                    fourierAccelList.get(0).get(1).get(i), fourierAccelList.get(0).get(2).get(i), fourierAccelList.get(0).get(4).get(i), 
                    fourierAccelList.get(0).get(6).get(i), fourierAccelList.get(0).get(8).get(i),
                    fourierAccelList.get(0).get(9).get(i), fourierAccelList.get(0).get(12).get(i), 
                    fourierAccelList.get(0).get(14).get(i), fourierAccelList.get(0).get(15).get(i),
                    fourierAccelList.get(1).get(0).get(i), fourierAccelList.get(1).get(1).get(i), fourierAccelList.get(1).get(2).get(i), 
                    fourierAccelList.get(1).get(4).get(i), fourierAccelList.get(1).get(5).get(i), fourierAccelList.get(1).get(6).get(i), 
                    fourierAccelList.get(1).get(7).get(i), 
                    fourierAccelList.get(1).get(13).get(i), fourierAccelList.get(1).get(14).get(i), fourierAccelList.get(2).get(1).get(i),
                    fourierAccelList.get(2).get(2).get(i), fourierAccelList.get(2).get(3).get(i), fourierAccelList.get(2).get(4).get(i), 
                    fourierAccelList.get(2).get(5).get(i), fourierAccelList.get(2).get(6).get(i),  fourierAccelList.get(2).get(10).get(i),
                    fourierAccelList.get(2).get(11).get(i), fourierAccelList.get(2).get(14).get(i),
                    fourierGyroList.get(0).get(0).get(i), fourierGyroList.get(0).get(1).get(i), fourierGyroList.get(0).get(2).get(i), 
                    fourierGyroList.get(0).get(3).get(i), fourierGyroList.get(0).get(4).get(i), fourierGyroList.get(0).get(5).get(i),
                    fourierGyroList.get(0).get(6).get(i), fourierGyroList.get(0).get(7).get(i), fourierGyroList.get(0).get(8).get(i),
                    fourierGyroList.get(0).get(9).get(i), fourierGyroList.get(0).get(12).get(i),
                    fourierGyroList.get(0).get(14).get(i), fourierGyroList.get(1).get(0).get(i), fourierGyroList.get(1).get(1).get(i),
                    fourierGyroList.get(1).get(2).get(i), fourierGyroList.get(1).get(3).get(i), fourierGyroList.get(1).get(4).get(i), 
                    fourierGyroList.get(1).get(5).get(i), fourierGyroList.get(1).get(6).get(i), fourierGyroList.get(1).get(7).get(i),
                    fourierGyroList.get(1).get(10).get(i), fourierGyroList.get(2).get(0).get(i), fourierGyroList.get(2).get(1).get(i),
                    fourierGyroList.get(2).get(3).get(i), fourierGyroList.get(2).get(5).get(i),
                    fourierGyroList.get(2).get(6).get(i), fourierGyroList.get(2).get(9).get(i), fourierGyroList.get(2).get(10).get(i), 
                    fourierMagnetList.get(0).get(0).get(i), 
                    fourierMagnetList.get(0).get(4).get(i), fourierMagnetList.get(0).get(5).get(i), fourierMagnetList.get(1).get(6).get(i),
                    fourierMagnetList.get(2).get(7).get(i), fourierRotateList.get(0).get(0).get(i), fourierRotateList.get(0).get(12).get(i), 
                    fourierRotateList.get(1).get(12).get(i), fourierRotateList.get(1).get(15).get(i), 
                    fourierRotateList.get(2).get(0).get(i), fourierRotateList.get(2).get(14).get(i), fourierRotateList.get(2).get(15).get(i), 
                    fourierAccelList.get(2).get(13).get(i), varAccelList[1].get(i), varAccelList[0].get(i),
